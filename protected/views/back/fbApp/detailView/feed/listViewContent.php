        ...
        <tr>
            <td>
                <?php if ($this->optionConfig['editable'] ):?>
                   <i class="glyphicon glyphicon-edit" title="Edit" style="cursor:pointer" onClick="location.href='<?php echo $this->createUrl(Yii::app()->controller->id.'/feedEdit',array_merge($_GET,array($this->primaryKey => $primaryKeyValue))); ?>'"></i>
                <?php endif; ?>
