...
<div class="container">
    ...
    <div id="dataContainer" class="container" style="overflow-x:auto">
        ...
        <form action="<?php echo $this->createUrl(Yii::app()->controller->id.'/feedUpdate',array($this->primaryKey => $thisRowData->{$this->primaryKey}));?>" method="POST" enctype="multipart/form-data" class="form-horizontal" onSubmit="return false;" id="editForm"  role="form">
